 ...
 *
 * Imports nothing from `obsidian` at runtime; read-orders.ts is the Obsidian side.
 */
...
export interface OrderRecord<F extends VaultFile = TFile> extends OrderForMatching {
  file: F;
}
 ...
 */
export function readOrdersFrom<F extends VaultFile>(
  host: VaultHost<F>,
