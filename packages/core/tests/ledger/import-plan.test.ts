...
describe('a row that pays an invoice', () => {
  const openBill = {
    title: '20260801_Musterversicherung_1000000001',
    companyTitle: 'Musterversicherung',
    amount: 30.35,
    currency: 'CHF',
    account: 4031,
    lines: [],
  ...
  const rows = bankRows(
    [
      '14.08.2026;14.08.2026;" Belastung e-banking / Ref.-Nr. 1563958107 MUSTERVERSICHERUNG AG ";30.35;;100.00;',
  ...
  it('takes the invoice account and says which invoice', () => {
    ...
    expect(paid?.settles?.bill.title).toBe('20260801_Musterversicherung_1000000001');
  ...
  it('lets one invoice be paid once, however many rows would fit it', () => {
    ...
    const twice = bankRows(
      [
        '14.08.2026;14.08.2026;" Belastung e-banking / Ref.-Nr. 1 MUSTERVERSICHERUNG AG ";30.35;;100.00;',
        '15.08.2026;15.08.2026;" Belastung e-banking / Ref.-Nr. 2 MUSTERVERSICHERUNG AG ";30.35;;69.65;',
        '',
      ].join('\n')
    );
