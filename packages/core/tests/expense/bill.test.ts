    ...
    const bill = parseBill(
      {
        ...
        document: '1 Areas/6 Finanzen/Rechnungen/Prämienrechnung_1000000001_01072026.pdf',
      },
      P
    );
...
describe('financeNoteStem', () => {
  ...
  it('stamps the day without separators, so the underscores only separate parts', () => {
    expect(financeNoteStem(day('2026-06-04'), 'baloise', '1000000001')).toBe(
  ...
  it('drops a missing part along with its separator', () => {
    ...
    expect(financeNoteStem(day('2026-06-04'), '', '1000000001')).toBe('20260604_1000000001');
