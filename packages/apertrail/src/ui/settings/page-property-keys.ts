...
const PROPERTY_GROUPS: PropertyGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'tagsProperty', label: 'tags' },
      { key: 'accommodationTypeProperty', label: 'accommodationType' },
      { key: 'accommodationStatusProperty', label: 'accommodationStatus' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'tripExtendsProperty', label: 'tripExtends' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'vehicleDeckPlanProperty', label: 'vehicleDeckPlan' },
      { key: 'vehicleCabinsProperty', label: 'vehicleCabins' },
    ],
  },
  {
    heading: 'settings.properties.groups.excursions',
    intro: 'settings.properties.groups.excursionsIntro',
    fields: [
