...
export const enTranslations = {
  ...
  vehicleBrochure: {
    ...
    caveat:
      'Everything on this page comes from this note. The cabins are the categories she is sold in; what one costs belongs to the sailing that books it. The notes are the record.',
  ...
  bookingSheet: {
    ...
    openNoDeparture:
      'The trip has no departure date yet. The lines above show their day of the trip instead of a date.',
    ...
    caveat:
      'This page is a printout of the current trip notes, to prepare a booking. Prices are the plan, not offers. The notes are what counts.',
