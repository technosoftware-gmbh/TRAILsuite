...
export const enTranslations = {
  ...
  prospect: {
    ...
    notYet: 'Not yet',
    caveat:
      'Everything on this page comes from this note. It is a printout, and the note is the record.',
  },
  vehicleBrochure: {
    ...
    caveat:
      'Everything on this page comes from this note. The cabins are the categories she is sold in; what one costs belongs to the sailing that books it.',
    footer:
      'Brochure generated by APERtrail on {date}. The notes are the record; this is a printout.',
  },
  tripDocument: {
    ...
    extensionsHint:
      'Each of these is a trip of its own, booked and priced separately. Their figures are not in the total above.',
    costs: 'What it costs',
    gallery: 'Pictures',
    day: 'Day {number}',
    ...
    caveat:
      'This page is a printout of the current trip notes. Please note that the prices shown here are the planned costs only. What has actually been spent is on the separate cost sheet beside it.',
    footer: '(Generated by APERtrail on {date})',
  },
  ...
  relatedTrips: {
    ...
    notASubject:
      'This note is not a city, place, person or vehicle, or it does not sit in a configured APERtrail folder.',
    noDate: '(no date)',
  },
  itinerary: {
    deckPlan: 'Deck plan',
  ...
  modals: {
    ...
    stopEditor: {
      ...
      excursionDesc:
        'The outing this stop is, as against the place it happens at. What it costs stays on this line: the same tour is priced differently on every trip that offers it.',
    ...
    tripEditor: {
      ...
      extendsHint:
        'The trip this one continues -- three days somewhere after the main one ends. Written here, on the trip that comes second.',
      ...
      variantsDesc:
        'The prices this same thing can be bought at: a cabin category, a room category, a longer version of the same excursion. Only the chosen one is ever counted, and the first one counts until you choose.',
      ...
      optional: 'Optional',
      optionalDesc:
        'Something that may or may not happen: an excursion offered, a transfer you might not take. Its price is shown but stays out of the planned total until you decide to do it.',
      ...
      legVehicleDesc:
        'Which ship or named train this leg is taken on, as against who runs it. Link it to a vehicle note and its cabin descriptions appear under the prices below.',
    ...
    noteCover: {
      ...
      descriptionHint:
        'One line, in the words a brochure would use. It is what goes under the title on the printed page. The long version is the summary below.',
      image: 'Picture',
      highlights: 'Highlights',
    ...
    noteSummary: {
      ...
      extraCallouts:
        'This note holds more than one summary callout. The first was edited; nothing reads the others.',
    },
    vehicleCabins: {
      cabins: 'Cabin categories',
      cabinsDesc:
        'The categories this one is sold in, and what each includes. A catalogue, not prices: what a cabin costs belongs to the trip that books it, and is typed on the leg.',
      descriptionDesc:
        'One or two lines, the way a brochure introduces her. The long version belongs in the note itself.',
      ...
      cabinImage: 'Picture',
      cabinImageDesc:
        'A vault path, a wikilink or a URL. Printed beside the cabin on the brochure.',
      deckPlanDesc:
        'A vault path or a wikilink to the document itself, usually a PDF. Linked from the leg, the card and the brochure; a path the vault cannot find shows nowhere.',
  ...
  settings: {
    ...
    properties: {
      ...
      groups: {
        ...
        vehicles: 'Vehicles',
        vehiclesIntro:
          'What a ship or a named train note carries. Its cabins are a catalogue rather than prices: what a cabin costs belongs to the sailing that books it, and lives on the trip.',
        excursions: 'Excursions',
        excursionsIntro:
          'What an excursion note carries. There is deliberately no price among them: the same tour costs one thing in December and another in May, so the figure lives on the trip that books it.',
  ...
  health: {
    ...
    variantCabinCheck: {
      ...
      explain:
        'A variant borrows its description from the cabin of the same name on the ship. These name a cabin their ship does not list and carry no description of their own, so nothing is shown where one would be. Variants that describe themselves are not listed: they lose nothing by not matching.',
      unknownCabin:
        '"{variant}" on the {leg} leg is not a cabin {vehicle} lists, and has no description of its own.',
    },
    photoSpotCheck: {
