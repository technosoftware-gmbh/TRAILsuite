...
export interface TripInput {
  ...
  rating: number | null;
  personTitles: string[];
  /** The trip this one follows on from, or null. Written on this note; the parent's list of extensions is derived. */
...
export function tripToInput(trip: TravelTrip): TripInput {
  return {
    ...
    extendsTitle: trip.extendsTitle,
    ...
    stops: trip.stops.map((stop) => ({
      ...
      excursionTitle: stop.excursionTitle,
      cost: stop.cost,
