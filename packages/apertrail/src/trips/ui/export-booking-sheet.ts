...
function flightsTable(lines: BookingSheetLines): BookingSheetTable {
  return {
    ...
    columns: [
      ...
      { label: t('bookingSheet.route'), width: 21 },
      { label: t('bookingSheet.departs'), width: 7 },
      { label: t('bookingSheet.arrives'), width: 8 },
      { label: t('bookingSheet.class'), width: 14 },
      { label: t('bookingSheet.reference'), width: 11 },
      { label: t('bookingSheet.price'), width: 12, num: true },
    ],
...
function transportTable(lines: BookingSheetLines): BookingSheetTable {
  return {
    ...
    columns: [
      { label: t('bookingSheet.date'), width: 13 },
      { label: t('bookingSheet.operator'), width: 18 },
      { label: t('bookingSheet.route'), width: 19 },
      { label: t('bookingSheet.departs'), width: 7 },
      { label: t('bookingSheet.arrives'), width: 7 },
      { label: t('bookingSheet.cabin'), width: 15 },
      { label: t('bookingSheet.reference'), width: 10 },
      { label: t('bookingSheet.price'), width: 11, num: true },
    ],
...
function hotelsTable(lines: BookingSheetLines): BookingSheetTable {
  ...
  return {
    ...
    columns: [
      ...
      { label: t('bookingSheet.accommodation'), width: 24 },
      { label: t('bookingSheet.room'), width: 20 },
...
function excursionsTable(lines: BookingSheetLines): BookingSheetTable {
  return {
    ...
    columns: [
      ...
      { label: t('bookingSheet.excursion'), width: 26 },
      { label: t('bookingSheet.place'), width: 13 },
